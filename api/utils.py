...
def recommend_gamesSVD(predictions_df,
                       userId,
    ...
    sorted_user_predictions = predictions_df.iloc[inverse_userId].sort_values(ascending=False)
    ...
    user_full = (user_data.merge(games_df, how='left', left_on='mGameId', right_on='mGameId').
    ...
    recommendations = (games_df[~games_df['mGameId'].isin(user_full['mGameId'])].
